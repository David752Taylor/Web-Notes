  ...
  <%@ page isELIgnored="true" %>
    ...
    <style type="text/css">
      ...
      #header .navs li.current {
        color: rgba(157, 126, 98, 1);
        font-size: 16px;
        border-radius: 0;
        border-width: 0 0 0 6px;
        border-style: solid;
        border-color: rgba(157, 126, 98, 1);
        background-color: rgba(247, 247, 247, 0);
        box-shadow: 0 0 3px rgba(0, 0, 0, .1);
      }
      ...
      #header .navs li:hover {
        ...
        border-style: solid;
        border-color: rgba(157, 126, 98, 1);
        background-color: rgba(110, 22, 64, 0);
        box-shadow: 0 0 3px rgba(0, 0, 0, .1);
      }
    </style>
    ...
    <body>
      ...
      <div id="header">
        <div v-if='true' class="nav-top">
          <img v-if='false' class="nav-top-img"
            src='http://codegen.caihongy.cn/20210225/e1e748927010494ca6dbe9032cf73b67.gif'>
        ...
        <div class="navs">
          ...
          <div class="list">
            <ul>
              <li class='current'><a href="javascript:navPage('./pages/home/home.jsp')" class="menumain"><i v-if="false"
                    class="layui-icon layui-icon-home"></i>首页</a></li>
              <li v-for="(item,index) in indexNav" v-bind:key="index"><a :href="'javascript:navPage(\''+item.url+'\')'"
                  class="menumain" style="cursor: pointer;"><i v-if="false" class="layui-icon"
                    :class="iconArr[index]"></i>{{item.name}}</a></li>
              ...
              <li><a :href="adminurl" target="_blank" class="menumain" style="cursor: pointer;"><i v-if="false"
                    class="layui-icon layui-icon-link"></i>服务</a></li>
            </ul>
          </div>
        </div>
      ...
      <div id="tabbar" v-if="true" class="tabbar"
        :style='{"padding":"20px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(157, 126, 98, 1)","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'
        style="position: relative;">
        <img v-if='false'
          :style='{"boxShadow":"0 0 6px rgba(110,22,64,.8)","margin":"0 auto","borderColor":"rgba(0,0,0,.3)","borderRadius":"100%","borderWidth":"1px","width":"44px","borderStyle":"solid","height":"44px"}'
          style='display: block;box-sizing: border-box;'
          src='http://codegen.caihongy.cn/20201024/ed5e326ca66f403aa3197b5fbb4ec733.jpg' />
        <div style='box-sizing: border-box;'
          :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(110,22,64,.8)","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"32px","fontSize":"14px","borderStyle":"solid"}'
          class="company"></div>
        <div style='box-sizing: border-box;'
          :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"32px","fontSize":"14px","borderStyle":"solid"}'
          class="record"></div>
        <div style='box-sizing: border-box;'
          :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"10px auto 30px auto","borderColor":"rgba(255,255,255,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"1px 0","width":"40%","lineHeight":"32px","fontSize":"14px","borderStyle":"solid"}'
          class="desc"></div>
      </div>
